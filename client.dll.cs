...
public nint m_iRetakesOffering = 0x1650; // int32
public nint m_iRetakesOfferingCard = 0x1654; // int32
public nint m_bRetakesHasDefuseKit = 0x1658; // bool
public nint m_bRetakesMVPLastRound = 0x1659; // bool
public nint m_iRetakesMVPBoostItem = 0x165C; // int32
public nint m_RetakesMVPBoostExtraUtility = 0x1660; // loadout_slot_t
public nint m_bNeedToReApplyGloves = 0x1680; // bool
public nint m_EconGloves = 0x1688; // C_EconItemView
public nint m_nEconGlovesChanged = 0x1AD0; // uint8
public nint m_bMustSyncRagdollState = 0x1AD1; // bool
public nint m_nRagdollDamageBone = 0x1AD4; // int32
public nint m_vRagdollDamageForce = 0x1AD8; // Vector
public nint m_vRagdollDamagePosition = 0x1AE4; // Vector
public nint m_szRagdollDamageWeaponName = 0x1AF0; // char[64]
public nint m_bRagdollDamageHeadshot = 0x1B30; // bool
public nint m_vRagdollServerOrigin = 0x1B34; // Vector
public nint m_bLastHeadBoneTransformIsValid = 0x2148; // bool
public nint m_lastLandTime = 0x214C; // GameTime_t
public nint m_bOnGroundLastTick = 0x2150; // bool
public nint m_qDeathEyeAngles = 0x216C; // QAngle
public nint m_bSkipOneHeadConstraintUpdate = 0x2178; // bool
public nint m_bLeftHanded = 0x2179; // bool
public nint m_fSwitchedHandednessTime = 0x217C; // GameTime_t
public nint m_flViewmodelOffsetX = 0x2180; // float32
public nint m_flViewmodelOffsetY = 0x2184; // float32
public nint m_flViewmodelOffsetZ = 0x2188; // float32
public nint m_flViewmodelFOV = 0x218C; // float32
public nint m_vecPlayerPatchEconIndices = 0x2190; // uint32[5]
public nint m_GunGameImmunityColor = 0x21C8; // Color
public nint m_vecBulletHitModels = 0x2218; // CUtlVector<C_BulletHitModel*>
public nint m_bIsWalking = 0x2230; // bool
public nint m_thirdPersonHeading = 0x2238; // QAngle
public nint m_flSlopeDropOffset = 0x2250; // float32
public nint m_flSlopeDropHeight = 0x2260; // float32
public nint m_vHeadConstraintOffset = 0x2270; // Vector
public nint m_entitySpottedState = 0x2288; // EntitySpottedState_t
public nint m_bIsScoped = 0x22A0; // bool
public nint m_bResumeZoom = 0x22A1; // bool
public nint m_bIsDefusing = 0x22A2; // bool
public nint m_bIsGrabbingHostage = 0x22A3; // bool
public nint m_iBlockingUseActionInProgress = 0x22A4; // CSPlayerBlockingUseAction_t
public nint m_flEmitSoundTime = 0x22A8; // GameTime_t
public nint m_bInNoDefuseArea = 0x22AC; // bool
public nint m_nWhichBombZone = 0x22B0; // int32
public nint m_iShotsFired = 0x22B4; // int32
public nint m_flVelocityModifier = 0x22B8; // float32
public nint m_flHitHeading = 0x22BC; // float32
public nint m_nHitBodyPart = 0x22C0; // int32
public nint m_bWaitForNoAttack = 0x22C4; // bool
public nint m_ignoreLadderJumpTime = 0x22C8; // float32
public nint m_bKilledByHeadshot = 0x22CD; // bool
public nint m_ArmorValue = 0x22D0; // int32
public nint m_unCurrentEquipmentValue = 0x22D4; // uint16
public nint m_unRoundStartEquipmentValue = 0x22D6; // uint16
public nint m_unFreezetimeEndEquipmentValue = 0x22D8; // uint16
public nint m_nLastKillerIndex = 0x22DC; // CEntityIndex
public nint m_bOldIsScoped = 0x22E0; // bool
public nint m_bHasDeathInfo = 0x22E1; // bool
public nint m_flDeathInfoTime = 0x22E4; // float32
public nint m_vecDeathInfoOrigin = 0x22E8; // Vector
public nint m_grenadeParameterStashTime = 0x22F4; // GameTime_t
public nint m_bGrenadeParametersStashed = 0x22F8; // bool
public nint m_angStashedShootAngles = 0x22FC; // QAngle
public nint m_vecStashedGrenadeThrowPosition = 0x2308; // Vector
public nint m_vecStashedVelocity = 0x2314; // Vector
public nint m_angShootAngleHistory = 0x2320; // QAngle[2]
public nint m_vecThrowPositionHistory = 0x2338; // Vector[2]
public nint m_vecVelocityHistory = 0x2350; // Vector[2]
        }
        ...
        public static class CBasePlayerController {
            public nint m_nFinalPredictedTick = 0x550; // int32
            public nint m_CommandContext = 0x558; // C_CommandContext
            public nint m_nInButtonsWhichAreToggles = 0x5F0; // uint64
            public nint m_nTickBase = 0x5F8; // uint32
            public nint m_hPawn = 0x5FC; // CHandle<C_BasePlayerPawn>
            public nint m_bKnownTeamMismatch = 0x600; // bool
            public nint m_hPredictedPawn = 0x604; // CHandle<C_BasePlayerPawn>
            public nint m_nSplitScreenSlot = 0x608; // CSplitScreenSlot
            public nint m_hSplitOwner = 0x60C; // CHandle<CBasePlayerController>
            public nint m_hSplitScreenPlayers = 0x610; // CUtlVector<CHandle<CBasePlayerController>>
            public nint m_bIsHLTV = 0x628; // bool
            public nint m_iConnected = 0x62C; // PlayerConnectedState
            public nint m_iszPlayerName = 0x630; // char[128]
            public nint m_steamID = 0x6B8; // uint64
            public nint m_bIsLocalPlayerController = 0x6C0; // bool
            public nint m_iDesiredFOV = 0x6C4; // uint32
        }
        // Parent: None
        // Fields count: 0
        //
...
public nint m_nNextPrimaryAttackTick = 0x15B0; // GameTick_t
public nint m_flNextPrimaryAttackTickRatio = 0x15B4; // float32
public nint m_nNextSecondaryAttackTick = 0x15B8; // GameTick_t
public nint m_flNextSecondaryAttackTickRatio = 0x15BC; // float32
public nint m_iClip1 = 0x15C0; // int32
public nint m_iClip2 = 0x15C4; // int32
public nint m_pReserveAmmo = 0x15C8; // int32[2]
        }
...
public nint m_pWeaponServices = 0x10F8; // CPlayer_WeaponServices*
public nint m_pItemServices = 0x1100; // CPlayer_ItemServices*
public nint m_pAutoaimServices = 0x1108; // CPlayer_AutoaimServices*
public nint m_pObserverServices = 0x1110; // CPlayer_ObserverServices*
public nint m_pWaterServices = 0x1118; // CPlayer_WaterServices*
public nint m_pUseServices = 0x1120; // CPlayer_UseServices*
public nint m_pFlashlightServices = 0x1128; // CPlayer_FlashlightServices*
public nint m_pCameraServices = 0x1130; // CPlayer_CameraServices*
public nint m_pMovementServices = 0x1138; // CPlayer_MovementServices*
public nint m_ServerViewAngleChanges = 0x1148; // C_UtlVectorEmbeddedNetworkVar<ViewAngleServerChange_t>
public nint m_nHighestConsumedServerViewAngleChangeIndex = 0x1198; // uint32
public nint v_angle = 0x119C; // QAngle
public nint v_anglePrevious = 0x11A8; // QAngle
public nint m_iHideHUD = 0x11B4; // uint32
public nint m_skybox3d = 0x11B8; // sky3dparams_t
public nint m_flDeathTime = 0x1248; // GameTime_t
public nint m_vecPredictionError = 0x124C; // Vector
public nint m_flPredictionErrorTime = 0x1258; // GameTime_t
public nint m_vecLastCameraSetupLocalOrigin = 0x125C; // Vector
public nint m_flLastCameraSetupTime = 0x1268; // GameTime_t
public nint m_flFOVSensitivityAdjust = 0x126C; // float32
public nint m_flMouseSensitivity = 0x1270; // float32
public nint m_vOldOrigin = 0x1274; // Vector
public nint m_flOldSimulationTime = 0x1280; // float32
public nint m_nLastExecutedCommandNumber = 0x1284; // int32
public nint m_nLastExecutedCommandTick = 0x1288; // int32
public nint m_hController = 0x128C; // CHandle<CBasePlayerController>
public nint m_bIsSwappingToPredictableController = 0x1290; // bool
        }
        // Parent: None
        // Fields count: 6
        //
...
public nint m_flFireSequenceStartTime = 0x1624; // float32
public nint m_nFireSequenceStartTimeChange = 0x1628; // int32
public nint m_nFireSequenceStartTimeAck = 0x162C; // int32
public nint m_ePlayerFireEvent = 0x1630; // PlayerAnimEvent_t
public nint m_ePlayerFireEventAttackType = 0x1634; // WeaponAttackType_t
public nint m_seqIdle = 0x1638; // HSequence
public nint m_seqFirePrimary = 0x163C; // HSequence
public nint m_seqFireSecondary = 0x1640; // HSequence
public nint m_thirdPersonFireSequences = 0x1648; // CUtlVector<HSequence>
public nint m_hCurrentThirdPersonSequence = 0x1660; // HSequence
public nint m_nSilencerBoneIndex = 0x1664; // int32
public nint m_thirdPersonSequences = 0x1668; // HSequence[7]
public nint m_ClientPreviousWeaponState = 0x16A0; // CSWeaponState_t
public nint m_iState = 0x16A4; // CSWeaponState_t
public nint m_flCrosshairDistance = 0x16A8; // float32
public nint m_iAmmoLastCheck = 0x16AC; // int32
public nint m_iAlpha = 0x16B0; // int32
public nint m_iScopeTextureID = 0x16B4; // int32
public nint m_iCrosshairTextureID = 0x16B8; // int32
public nint m_flGunAccuracyPositionDeprecated = 0x16BC; // float32
public nint m_nLastEmptySoundCmdNum = 0x16C0; // int32
public nint m_nViewModelIndex = 0x16C4; // uint32
public nint m_bReloadsWithClips = 0x16C8; // bool
public nint m_flTimeWeaponIdle = 0x16CC; // GameTime_t
public nint m_bFireOnEmpty = 0x16D0; // bool
public nint m_OnPlayerPickup = 0x16D8; // CEntityIOOutput
public nint m_weaponMode = 0x1700; // CSWeaponMode
public nint m_flTurningInaccuracyDelta = 0x1704; // float32
public nint m_vecTurningInaccuracyEyeDirLast = 0x1708; // Vector
public nint m_flTurningInaccuracy = 0x1714; // float32
public nint m_fAccuracyPenalty = 0x1718; // float32
public nint m_flLastAccuracyUpdateTime = 0x171C; // GameTime_t
public nint m_fAccuracySmoothedForZoom = 0x1720; // float32
public nint m_fScopeZoomEndTime = 0x1724; // GameTime_t
public nint m_iRecoilIndex = 0x1728; // int32
public nint m_flRecoilIndex = 0x172C; // float32
public nint m_bBurstMode = 0x1730; // bool
public nint m_flLastBurstModeChangeTime = 0x1734; // GameTime_t
public nint m_nPostponeFireReadyTicks = 0x1738; // GameTick_t
public nint m_flPostponeFireReadyFrac = 0x173C; // float32
public nint m_bInReload = 0x1740; // bool
public nint m_bReloadVisuallyComplete = 0x1741; // bool
public nint m_flDroppedAtTime = 0x1744; // GameTime_t
public nint m_bIsHauledBack = 0x1748; // bool
public nint m_bSilencerOn = 0x1749; // bool
public nint m_flTimeSilencerSwitchComplete = 0x174C; // GameTime_t
public nint m_iOriginalTeamNumber = 0x1750; // int32
public nint m_iMostRecentTeamNumber = 0x1754; // int32
public nint m_bDroppedNearBuyZone = 0x1758; // bool
public nint m_flNextAttackRenderTimeOffset = 0x175C; // float32
public nint m_bClearWeaponIdentifyingUGC = 0x17F8; // bool
public nint m_bVisualsDataSet = 0x17F9; // bool
public nint m_bOldFirstPersonSpectatedState = 0x17FA; // bool
public nint m_bUIWeapon = 0x17FB; // bool
public nint m_nCustomEconReloadEventId = 0x17FC; // int32
...
public nint m_gunHeat = 0x1838; // float32
public nint m_smokeAttachments = 0x183C; // uint32
public nint m_lastSmokeTime = 0x1840; // GameTime_t
public nint m_flNextClientFireBulletTime = 0x1844; // float32
public nint m_flNextClientFireBulletTime_Repredict = 0x1848; // float32
public nint m_IronSightController = 0x1920; // C_IronSightController
public nint m_iIronSightMode = 0x19D0; // int32
public nint m_flLastLOSTraceFailureTime = 0x19E0; // GameTime_t
public nint m_iNumEmptyAttacks = 0x19E4; // int32
public nint m_flLastMagDropRequestTime = 0x1A60; // GameTime_t
public nint m_flWatTickOffset = 0x1A64; // float32
        }
        // Parent: C_BaseModelEntity
        // Fields count: 0
...
public nint m_vecVelocity = 0x3E0; // CNetworkVelocityVector
public nint m_vecBaseVelocity = 0x410; // Vector
public nint m_hEffectEntity = 0x41C; // CHandle<C_BaseEntity>
public nint m_hOwnerEntity = 0x420; // CHandle<C_BaseEntity>
public nint m_MoveCollide = 0x424; // MoveCollide_t
public nint m_MoveType = 0x425; // MoveType_t
public nint m_nActualMoveType = 0x426; // MoveType_t
public nint m_flWaterLevel = 0x428; // float32
public nint m_fEffects = 0x42C; // uint32
public nint m_hGroundEntity = 0x430; // CHandle<C_BaseEntity>
public nint m_nGroundBodyIndex = 0x434; // int32
public nint m_flFriction = 0x438; // float32
public nint m_flElasticity = 0x43C; // float32
public nint m_flGravityScale = 0x440; // float32
public nint m_flTimeScale = 0x444; // float32
public nint m_bAnimatedEveryTick = 0x448; // bool
public nint m_flNavIgnoreUntilTime = 0x44C; // GameTime_t
public nint m_hThink = 0x450; // uint16
public nint m_fBBoxVisFlags = 0x460; // uint8
public nint m_bPredictable = 0x461; // bool
public nint m_bRenderWithViewModels = 0x462; // bool
public nint m_nSplitUserPlayerPredictionSlot = 0x464; // CSplitScreenSlot
public nint m_nFirstPredictableCommand = 0x468; // int32
public nint m_nLastPredictableCommand = 0x46C; // int32
public nint m_hOldMoveParent = 0x470; // CHandle<C_BaseEntity>
public nint m_Particles = 0x478; // CParticleProperty
public nint m_vecPredictedScriptFloats = 0x4A0; // CUtlVector<float32>
public nint m_vecPredictedScriptFloatIDs = 0x4B8; // CUtlVector<int32>
public nint m_nNextScriptVarRecordID = 0x4E8; // int32
public nint m_vecAngVelocity = 0x4F8; // QAngle
public nint m_DataChangeEventRef = 0x504; // int32
public nint m_dependencies = 0x508; // CUtlVector<CEntityHandle>
public nint m_nCreationTick = 0x520; // int32
public nint m_bAnimTimeChanged = 0x52D; // bool
public nint m_bSimulationTimeChanged = 0x52E; // bool
...
public nint m_pInGameMoneyServices = 0x6F0; // CCSPlayerController_InGameMoneyServices*
public nint m_pInventoryServices = 0x6F8; // CCSPlayerController_InventoryServices*
public nint m_pActionTrackingServices = 0x700; // CCSPlayerController_ActionTrackingServices*
public nint m_pDamageServices = 0x708; // CCSPlayerController_DamageServices*
public nint m_iPing = 0x710; // uint32
public nint m_bHasCommunicationAbuseMute = 0x714; // bool
public nint m_szCrosshairCodes = 0x718; // CUtlSymbolLarge
public nint m_iPendingTeamNum = 0x720; // uint8
public nint m_flForceTeamTime = 0x724; // GameTime_t
public nint m_iCompTeammateColor = 0x728; // int32
public nint m_bEverPlayedOnTeam = 0x72C; // bool
public nint m_flPreviousForceJoinTeamTime = 0x730; // GameTime_t
public nint m_szClan = 0x738; // CUtlSymbolLarge
public nint m_sSanitizedPlayerName = 0x740; // CUtlString
public nint m_iCoachingTeam = 0x748; // int32
public nint m_nPlayerDominated = 0x750; // uint64
public nint m_nPlayerDominatingMe = 0x758; // uint64
public nint m_iCompetitiveRanking = 0x760; // int32
public nint m_iCompetitiveWins = 0x764; // int32
public nint m_iCompetitiveRankType = 0x768; // int8
public nint m_iCompetitiveRankingPredicted_Win = 0x76C; // int32
public nint m_iCompetitiveRankingPredicted_Loss = 0x770; // int32
public nint m_iCompetitiveRankingPredicted_Tie = 0x774; // int32
public nint m_nEndMatchNextMapVote = 0x778; // int32
public nint m_unActiveQuestId = 0x77C; // uint16
public nint m_nQuestProgressReason = 0x780; // QuestProgress::Reason
public nint m_unPlayerTvControlFlags = 0x784; // uint32
public nint m_iDraftIndex = 0x7B0; // int32
public nint m_msQueuedModeDisconnectionTimestamp = 0x7B4; // uint32
public nint m_uiAbandonRecordedReason = 0x7B8; // uint32
public nint m_bCannotBeKicked = 0x7BC; // bool
public nint m_bEverFullyConnected = 0x7BD; // bool
public nint m_bAbandonAllowsSurrender = 0x7BE; // bool
public nint m_bAbandonOffersInstantSurrender = 0x7BF; // bool
public nint m_bDisconnection1MinWarningPrinted = 0x7C0; // bool
public nint m_bScoreReported = 0x7C1; // bool
public nint m_nDisconnectionTick = 0x7C4; // int32
public nint m_bControllingBot = 0x7D0; // bool
public nint m_bHasControlledBotThisRound = 0x7D1; // bool
public nint m_bHasBeenControlledByPlayerThisRound = 0x7D2; // bool
public nint m_nBotsControlledThisRound = 0x7D4; // int32
public nint m_bCanControlObservedBot = 0x7D8; // bool
public nint m_hPlayerPawn = 0x7DC; // CHandle<C_CSPlayerPawn>
public nint m_hObserverPawn = 0x7E0; // CHandle<C_CSObserverPawn>
public nint m_bPawnIsAlive = 0x7E4; // bool
public nint m_iPawnHealth = 0x7E8; // uint32
public nint m_iPawnArmor = 0x7EC; // int32
public nint m_bPawnHasDefuser = 0x7F0; // bool
public nint m_bPawnHasHelmet = 0x7F1; // bool
public nint m_nPawnCharacterDefIndex = 0x7F2; // uint16
public nint m_iPawnLifetimeStart = 0x7F4; // int32
public nint m_iPawnLifetimeEnd = 0x7F8; // int32
public nint m_iPawnBotDifficulty = 0x7FC; // int32
public nint m_hOriginalControllerOfCurrentPawn = 0x800; // CHandle<CCSPlayerController>
public nint m_iScore = 0x804; // int32
public nint m_vecKills = 0x808; // C_NetworkUtlVectorBase<EKillTypes_t>
public nint m_bMvpNoMusic = 0x820; // bool
public nint m_eMvpReason = 0x824; // int32
public nint m_iMusicKitID = 0x828; // int32
public nint m_iMusicKitMVPs = 0x82C; // int32
public nint m_iMVPs = 0x830; // int32
public nint m_bIsPlayerNameDirty = 0x834; // bool
        }
        // Parent: C_CSWeaponBaseGun
        // Fields count: 0
...
public nint m_bBombTicking = 0xED0; // bool
public nint m_nBombSite = 0xED4; // int32
public nint m_nSourceSoundscapeHash = 0xED8; // int32
public nint m_entitySpottedState = 0xEE0; // EntitySpottedState_t
public nint m_flNextGlow = 0xEF8; // GameTime_t
public nint m_flNextBeep = 0xEFC; // GameTime_t
public nint m_flC4Blow = 0xF00; // GameTime_t
public nint m_bCannotBeDefused = 0xF04; // bool
public nint m_bHasExploded = 0xF05; // bool
public nint m_flTimerLength = 0xF08; // float32
public nint m_bBeingDefused = 0xF0C; // bool
public nint m_bTriggerWarning = 0xF10; // float32
public nint m_bExplodeWarning = 0xF14; // float32
public nint m_bC4Activated = 0xF18; // bool
public nint m_bTenSecWarning = 0xF19; // bool
public nint m_flDefuseLength = 0xF1C; // float32
public nint m_flDefuseCountDown = 0xF20; // GameTime_t
public nint m_bBombDefused = 0xF24; // bool
public nint m_hBombDefuser = 0xF28; // CHandle<C_CSPlayerPawn>
public nint m_hControlPanel = 0xF2C; // CHandle<C_BaseEntity>
public nint m_hDefuserMultimeter = 0xF30; // CHandle<C_Multimeter>
public nint m_flNextRadarFlashTime = 0xF34; // GameTime_t
public nint m_bRadarFlash = 0xF38; // bool
public nint m_pBombDefuser = 0xF3C; // CHandle<C_CSPlayerPawn>
public nint m_fLastDefuseTime = 0xF40; // GameTime_t
public nint m_pPredictionOwner = 0xF48; // CBasePlayerController*
public nint m_vecC4ExplodeSpectatePos = 0xF50; // Vector
public nint m_vecC4ExplodeSpectateAng = 0xF5C; // QAngle
public nint m_flC4ExplodeSpectateDuration = 0xF68; // float32
        }
        // Parent: CBaseAnimGraph
        // Fields count: 8
        //
